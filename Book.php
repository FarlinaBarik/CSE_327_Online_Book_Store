...
session_start();
	...
	$typee = $_SESSION['type'];
	$query9= mysqli_query($link,"Select * from Books where Book_id = '$Book_id'  ");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$review = mysqli_real_escape_string($link2,$_POST['review']);
		 $bool = true;
	mysqli_select_db($link2,"Online_Bookstore") or die("Cannot connect to database"); //Connect to database
